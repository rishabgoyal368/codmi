            ...
            <div class="row flex-grow">
                <div class="col-lg-4 mx-auto">
                    ...
                    <div class="auth-form-light text-left p-5">
                        ...
                        <h4>Sign up.</h4>
                        <form class="pt-3" method="POST" action="{{route('admin_register')}}" id="login">
                            @csrf
                            ...
                            <div class="form-group">
                                <input type="radio" name="role" id="" value="1" required> User
                                <input type="radio" name="role" id="" value="2" required> Retail
                            </div>
                            @if ($errors->has('password'))
                            <span class="text-danger">{{ $errors->first('password') }}</span>
                            @endif
